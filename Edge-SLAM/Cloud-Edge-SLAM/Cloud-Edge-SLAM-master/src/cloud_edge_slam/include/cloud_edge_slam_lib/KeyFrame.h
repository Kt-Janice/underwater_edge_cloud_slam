...
public:
    ...
    KeyFrame(double timeStamp, const Sophus::SE3f &Tcw, const std::vector<cv::KeyPoint> &vKeysUn, const cv::Mat &descriptors, ORB_SLAM3::Map* pMap, ORB_SLAM3::KeyFrameDatabase* pKFDB, ORB_SLAM3::GeometricCamera* pCamera);
    bool mbIsFakeDescriptor = false;
